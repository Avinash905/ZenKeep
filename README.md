...
<a href="https://Avinash905.github.io/zen-keep" target="_blank">Click here</a>👈 To check the app.

### 📃Features :

<ul>
<li>Creates todo</li>
<li>Edit existing todo</li>
<li>Delete your todo</li>
<li>All todos are stored in your local storage so that refreshing the page or closing the site won't effect your data</li>
</ul>
